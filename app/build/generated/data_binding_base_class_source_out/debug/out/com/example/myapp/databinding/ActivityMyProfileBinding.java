...
public final class ActivityMyProfileBinding implements ViewBinding {
  ...
  private ActivityMyProfileBinding(@NonNull LinearLayout rootView, @NonNull CardView image) {
  ...
  public static ActivityMyProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.image;
      CardView image = ViewBindings.findChildViewById(rootView, id);
      if (image == null) {
        break missingId;
      }

      return new ActivityMyProfileBinding((LinearLayout) rootView, image);
    }
